...
Esta a cargo de 59 (NPS) Parques Nacionales y Reservas Naturales distribuidos en distintas zonas del pais\
\
- Proteger y asegurar la conservacion de ambientes naturales y su biodiversidad\
- MAS CACA
...
Exite [Registro de la Biodiversidad](https://www.kaggle.com/nationalparkservice/park-biodiversity/home) de `r s` especies distintas de organizadas en `r f` Familias en los `r p` Parques.\
\
...
\
- Plantear posibles variables que intervengan en la relación \


## Riqueza de Especies en los Parques Nacionales 
...
Map.Parks.Flora
```
Fig 1. Riqueza de Flora en Parques Nacionales



## Correlacion Especies Fungicas por Hectareas de Parque
...
## Correlacion Especies Animales por Hectareas de Parque
...
```
Fig 4. Diagrama de Dispersion Especies Animales por Hectareas Parque


## Correlacion Especies Vegetales por Hectareas de Parque
...
## Correlacion de Diversidad de Especies por Hectareas de Parque
